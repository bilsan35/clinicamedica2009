...
#Region "Rotinas"
    ...
    Private Sub CargaGrid(ByVal filtro As String)
        ...
        sql = "select *  from vwEnfermeira where Nome like '%x%'"
    ...
    Private Function Deletar(ByVal ID As String) As Boolean
        ...
        sql = "delete from TBENFERMEIRA where ID = '@ID'"
...
#Region "Eventos"
    ...
    Private Sub btnNovo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNovo.Click
        ...
        Dim frmCadastroEnfermeiras As New frmCadastroEnfermeiras

        frmCadastroEnfermeiras.ShowDialog()
    ...
    Private Sub Editar()
        Try
            ...
            Dim objEdicao As New frmCadastroEnfermeiras(CHAVE)
