Namespace UTFPR
    ...
    Public Class classSecretaria
        ...
        Private Sub Recuperar()
            Dim sql As String
            sql = "select * from TBSECRETARIA where ID ='" & pID & "'"
        ...
        Public Function Delete() As Boolean
            ...
            Dim sql As String
            sql = "delete * from TBSECRETARIA where ID = '" & pID & "'"
        ...
        Public Function save() As Boolean
            ...
            If Acao = TipoAcao.Inserir Then
                sql = "insert into TBSECRETARIA(NOME,RG,CPF,DATANASCIMENTO,ESTADOCIVIL,SEXO,CELULAR,EMAIL,LOGRADOURO,NUMERO,COMPLEMENTO,BAIRRO,CIDADE,CEP,ESTADO,TELEFONE) values('" & Nome & "','" & RG & "','" & CPF & "','" & DataNascimento & "','" & EstadoCivil & "','" & Sexo & "','" & Celular & "','" & Email & "','" & Lougradouro & "','" & Numero & "','" & Complemento & "','" & Bairro & "','" & Cidade & "','" & CEP & "','" & Estado & "','" & Telefone & "')"
            Else
                sql = "update TBSECRETARIA set Nome ='" & Nome & _
                    "',RG ='" & RG & _
                    "',CPF ='" & CPF & _
