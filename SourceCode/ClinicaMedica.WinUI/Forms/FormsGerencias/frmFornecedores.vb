...
#Region "Rotinas"
    ...
    Private Sub CargaGrid(ByVal filtro As String)
        ...
        sql = "select *  from vwFornecedor where Nome like '%x%'"
...
#Region "Eventos"
    ...
    Private Sub Editar()
        Try
            ...
            Dim objEdicao As New frmCadastroFornecedores(CHAVE)
...
#End Region
    ...
    Private Sub btnNovo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNovo.Click
        ...
        Dim frmCadastroFornecedores As New frmCadastroFornecedores
